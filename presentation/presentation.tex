...
%			\item Divided in \emph{knowledge areas} (KAs)
			...
			\item Does not account any hour load on calculus, linear algebra, differential equations, etc
		\end{itemize}
	\end{colorblock}
\end{column}
\begin{column}{0.5\textwidth}
	\begin{colorblock}{SBC CR2005}{bg=RawSienna!10}{bg=RawSienna!70}
		\begin{itemize}
			...
			\item \textbf{\textcolor{n_blue}{Definition of math}} used in this paper
		\end{itemize}
	\end{colorblock}
\end{column}
\end{columns}
