...
\begin{tikzpicture}
	...
	ylabel={\% Percentage of math in curriculum},
...
%	nodes near coords align={vertical},
	...
	\addplot 
		coordinates {(ICMC/USP,12.29) (IME/USP,25.13) (PUC-RS,7.88) (UFC,10.24) (UFCG,13.46) (UFMG,10.86) (UFPE,10.73) (UFRGS,12.24) (UFRJ,15.90) (UFSC,10.71) (UNICAMP,17.50)};
	\addplot[red,sharp plot]
		coordinates {(pre,15.36) (pos,15.36)}
		node[above] at (axis cs:UFMG,15.36) {ACM};
	\addplot[red,sharp plot]
